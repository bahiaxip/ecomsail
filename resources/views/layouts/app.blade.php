...
<body>
    ...
    @if(Route::is(['list_users','list_categories','list_products','list_attributes','list_locations','list_cities','list_home','list_orders','list_invoices','carousel','settings','roles']))
    <div class="content">
        <div class="sectionL">
