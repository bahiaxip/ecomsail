<!-- Modal crear usuario -->
<div wire:ignore.self class="modal fade " id="addSlider" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
        ...
        <form enctype="multipart/form-data">
          ...
          <div class="row mtop16">
              ...
              <div class="col-md-6 thumbnails">
                  ...
                  @if($aux_image)
                    <label for="customFile" >Imagen seleccionada</label>
