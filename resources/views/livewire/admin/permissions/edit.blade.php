<!-- Modal crear usuario -->
<div wire:ignore.self class="modal fade " id="editPermission" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      ...
      <div id="loading" style="display: none;width:100%;height:100%;position:absolute;background-color: rgba(0,0,0,.5);z-index:999" >
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-sm btn-sm btn_sail btn_pry" wire:click="update">Actualizar</button>
        </div>
