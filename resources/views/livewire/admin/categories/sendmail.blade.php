  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
          ...
          @if($count_cat==0)
          <button type="button" class="btn btn-sm btn-primary text-white" data-dismiss="modal" wire:click="sendEmail" id="btn_sendemail">Enviar</button>
        @endif
      </div>
    </div>
  </div>
...
<script>
  ...
  let btn_sendemail=document.querySelector('#btn_sendemail');
  if(btn_sendemail){
