                                ...
                                @foreach($combinations as $comb)
                                  ...
                                  <tr class="tr_{{$comb->id}}">
                                    ...
                                    <td class="added_price">
                                        {{ Form::number('added_price',$comb->added_price,['class' => 'form-control form-control-sm','disabled','step' => '1','onchange' => 'update_added_price(this)','onpaste' => 'return false']) }}
                                    </td>
                                    {{--
                                    ...
                                    --}}
                                    <td class="stock">
                                        {{ Form::number('stock_comb',$comb->stock,['class' => 'form-control form-control-sm','disabled','onkeydown' => 'return false','onpaste' => 'return false','step' => 1,'onchange' => 'update_stock(this)','max' => $stock_final + $comb->stock,'min' => 0]) }}
                                    </td>
                                    <td>
