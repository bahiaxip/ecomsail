            ...
            @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 d-flex">
                    <div class="panel shadow">
                      ...
                      <div class="box">            
                        ...
                        <div class="form-check">
                            {{ Form::checkbox('user_permissions',"true",($this->permissions2->testPermission($this->permissions3,'user_permissions')) ? 'checked':'',['class' => 'form-check-input','id' => 'user_permissions','wire:model'=>$this->permissions['users']['list_users']]) }}
                            {{ Form::label('user_permissions','Editar permisos de usuarios') }}                          
                        </div>
                  ...
                  <div class="col-lg-4 d-flex">
                    <div class="panel shadow">
                      <div class="header">
                        <h2 class="title"><i class="fas fa-tags"></i> Categorías</h2>
                      </div>
                      <div class="box">            
                        <div class="form-check">
